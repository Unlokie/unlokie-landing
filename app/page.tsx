    ...
    <main>
      ...
      <section id="main-content" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-lightGray">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div>
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-semibold text-charcoal mb-6">
              Smart sports gear,
              <br />
              <span className="text-unlokieGreen">right where you play.</span>
            </h1>
            <p className="text-xl sm:text-2xl text-slateGray mb-8 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="mt-16">
            <div className="text-sm text-coolGray mb-4">Play. Share. Repeat.</div>
            <div className="w-16 h-1 bg-unlokie-gradient mx-auto rounded-full"></div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="order-2 lg:order-1">
              <div className="bg-gray-50 rounded-2xl p-8 flex items-center justify-center">
                <div className="text-center">
                  ...
                  />
                  <div className="text-sm text-gray-600 mt-4">Smart Locker System</div>
                  <div className="text-xs text-gray-500">Contactless access, weather-resistant design</div>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Contactless Unlock</h3>
                  <p className="text-gray-700">Tap your phone to access gear instantly—no keys, no hassle</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">See what's available before you head out to play</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Weather-resistant with UV-stable materials for years of use</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Simple Operations</h3>
                  <p className="text-gray-700">Easy maintenance with remote monitoring and battery alerts</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-2">Find</h4>
                <p className="text-gray-600">Locate nearby lockers at schools, clubs, or parks</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-2">Unlock</h4>
                <p className="text-gray-600">Tap your phone to open and access gear</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-2">Play</h4>
                <p className="text-gray-600">Enjoy your game with quality shared equipment</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-2">Return</h4>
                <p className="text-gray-600">Put gear back and help others play too</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 lg:p-12">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl p-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-4">⚡ Tech Readiness</h4>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
              ...
              <div className="bg-white rounded-xl p-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-4">💰 Market Need</h4>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-green-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Municipal Parks</h3>
              <p className="text-gray-700 mb-4">Increase park utilization and community engagement with accessible shared equipment</p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Schools & Universities</h3>
              <p className="text-gray-700 mb-4">Provide students instant access to sports gear without the storage hassles</p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <svg className="w-4 h-4 text-green-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              ...
              <p className="text-gray-700">Lower barriers to recreation and community participation</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Community Activation</h3>
              <p className="text-gray-700">Transform underused spaces into vibrant activity hubs</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Equipment Reuse</h3>
              <p className="text-gray-700">Maximize utilization and extend equipment lifecycle</p>
            </div>
          </div>
      ...
      {/* Traction Section */}
      <section id="traction" className="py-16 lg:py-24 bg-white">
