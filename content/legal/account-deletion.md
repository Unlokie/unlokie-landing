...
- your access to the account is revoked immediately;
- final deletion is not instant;
- your personal data is deleted or irreversibly anonymized within **30 days** of the request.

Some requests may require issue resolution before deletion can be completed, for example if there is:

- an active rental or session;
...
- disputes, chargebacks, and legal compliance records.
